import { Settings, Construction, Music, Keyboard, Volume2, Palette, Sparkles } from 'lucide-react';

interface SettingsPanelProps {
  onGoToSongSetup?: () => void;
}

export function SettingsPanel({ onGoToSongSetup }: SettingsPanelProps) {
  return (
